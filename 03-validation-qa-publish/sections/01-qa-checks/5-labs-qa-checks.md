...
This lab assumes you completed **Lab 6: Develop Markdown and Content** in the **Contents** menu on the right.
...
8. Your stakeholders will verify the QA. They will reach out via WMS if more changes are needed. Otherwise, they will move the workshop to **Completed** status. If you have not heard back from your stakeholders 2 business days after submitting the Self QA form, message them via WMS. While waiting to hear back, you can move to **Lab 10: Publish your workshop** and prepare the publishing request.

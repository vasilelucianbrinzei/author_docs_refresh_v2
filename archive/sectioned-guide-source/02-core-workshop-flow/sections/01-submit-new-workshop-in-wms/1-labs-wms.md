...
6. Complete the **Self QA Checklist** tab. See **Lab 7: QA checks and steps** for self-QA details.
...
8. The workshop is *completed* and ready for publishing. Submit a publishing request by following **Lab 10: Publish your workshop**. After approval, the workshop goes live within one business day.

...
1. If you have not generated SSH keys on your local computer, first follow the optional **Generate SSH keys** guidance before you continue with the SSH setup below.

...
## Task 1: Use The Guide In The Right Order
...
| Help and Support | FAQ, support routes, and response-time guidance | As needed |

## Task 2: Use The Background Pages Before The Main Workflow When Needed

| Page | Open it when | Then continue with |
| --- | --- | --- |
| Background: WMS lifecycle | You need context on statuses, approvals, or handoffs | Lab 1 or Validation and Publish |
| Background: GitHub foundations | You need context on repositories, forks, clones, or previews | Lab 2 or Lab 3 |

## Task 3: Follow The Main Author Path

1. Start with **Core Workflow**.
2. Use the two background pages in the **Core Workflow** sequence right before the labs they support.
3. Use **Tools and Productivity** and **Reuse and Enhancements** only when those topics become relevant to the workshop you are building.
...
6. Return to **Help and Support** whenever you need FAQ, support, or SLA guidance.
